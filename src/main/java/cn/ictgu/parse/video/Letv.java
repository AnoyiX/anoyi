...
public class Letv implements Parser<Video>{
  ...
  private final static String ROUTE = "http://player-pc.le.com/mms/out/video/playJson.json?platid=3&splatid=301&tss=no&id=%s&detect=0&dvtype=1000&accessyx=1&domain=m.le.com&tkey=%s&devid=178D3CF87F892133E76A7BBEB78C903E70564321&source=1001&lang=cn&region=cn&isHttps=0";
  private final static String VIP_LOCATION = "%s%s&token=%s&uid=67945963&format=1&jsonp=vjs_149067353337651&expect=3&p1=0&p2=04&termid=2&ostype=android&hwtype=un&uuid=1673532722810457&vid=%s&";
